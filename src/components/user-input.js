...
const UserInput = (props) => {
    let { planets, vehicles, index, planetSelectHandler, vehicleSelectHandler, showDropDown, selectedPlanet, selectedVehicle } = props;
    return (
        <div className="user-input-container">
            <div className="destination-text">Destination {index}</div>
            <div className="planets-container">
                <PlanetDropDown planets = {planets} planetSelectHandler={planetSelectHandler} selected = {(selectedPlanet && selectedPlanet.name) || []}/>
            </div>
