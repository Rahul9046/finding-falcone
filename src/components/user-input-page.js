...
const UserInputPage = (props) => {
    let { planets, vehicles, noOfInputs, planets_selected, vehicles_selected, totalTime, planetSelectHandler, vehicleSelectHandler, findResultHandler, history } = props;
    return (
        <div className="home-main-container">
            ...
            <Find history = {history} disabled={ vehicles_selected.length === noOfInputs ? false : true} findResultHandler={findResultHandler}/>
        </div>
    );
}
